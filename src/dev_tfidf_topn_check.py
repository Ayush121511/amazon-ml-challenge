"""Test TF-IDF cosine similarity (sparse_dot_topn, top_n=50) blocking against
the dev sample, same measurement pattern as the other dev_*_check.py scripts.
"""
import sys
import time
